...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'lead_center_userinfo', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'UserInfo', fields ['user']
        db.create_unique(u'lead_center_userinfo', ['user_id'])

        # Adding field 'LeadComment.user'
        db.add_column(u'lead_center_leadcomment', 'user',
    ...
    def backwards(self, orm):
        ...
        db.delete_unique(u'lead_center_userinfo', ['user_id'])


        # Changing field 'UserInfo.user'
        db.alter_column(u'lead_center_userinfo', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Deleting field 'LeadComment.user'
        db.delete_column(u'lead_center_leadcomment', 'user_id')
